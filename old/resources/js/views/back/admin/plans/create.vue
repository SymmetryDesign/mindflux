<template>
    <v-app-default-layout>
        <template v-slot:header>
            <h1 class="text-2xl font-semibold text-gray-900">{{ $trans('headings.create-plan') }}</h1>
        </template>
                                ...
                                <div class="grid grid-cols-3 gap-6 mb-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-input" v-model="form.plan_id">
                                ...
                                <div class="grid grid-cols-3 gap-6 mb-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-input" v-model.number="form.trial_days">
                                        </div>
...
<script>
    ...
    export default {
        metaInfo() {
            return {
                title: this.$trans('headings.create-plan')
            }
        },
        ...
        methods: {
            submit() {
                ...
                this.$inertia.post(route('admin:plans.store'), this.form.data())
