                        ...
                        <li class="border-b border-gray-100 last:border-0" v-for="project in $page.projects.data">
                                <div class="px-6 py-4 flex items-center">
                                    <div class="min-w-0 flex-1 md:grid md:grid-cols-8 md:gap-4">
                                        ...
                                        <div class="jam mt-2 items-center flex md:col-span-2 sm:mt-0" v-if="project.jamboard_url !=null">
                                            <div class="px-0 sm:px-2">
                                               
                                                <a target="_blank" :href="project.jamboard_url" class="btn btn-indigo jam-btn">
                                        ...
                                        <div class="mt-2 items-center flex md:col-span-2 sm:mt-0" v-else>
                                            <div class="px-0 sm:px-2">
